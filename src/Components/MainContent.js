  ...
  return (
    <div>
      <div className="headercontainer">
        <h2 className="heading">BitCoin (BTC)</h2>
        <div
          style={{
            display: "flex",
      ...
      {value === 0 ? (
        <>
          <div className="card-content">
            <h2 className="heading">What is Bitcoin (BTC)?</h2>
            <p>
              Bitcoin is a digital currency created in January 2009. It follows
              the ideas set out in a whitepaper by the mysterious and
              pseudonymous Satoshi Nakamoto.1 The identity of the person or
              persons who created the technology is still a mystery. Bitcoin
              offers the promise of lower transaction fees than traditional
              online payment mechanisms and, unlike government-issued
              currencies, it is operated by a decentralized authority. Bitcoin
              is a type of cryptocurrency. There is no physical bitcoin, only
              balances kept on a public ledger that everyone has transparent
              access to. All bitcoin transactions are verified by a massive
              amount of computing power. Bitcoin is not issued or backed by any
              banks or governments, nor is an individual bitcoin valuable as a
              commodity. Despite it not being legal tender in most parts of the
              world, bitcoin is very popular and has triggered the launch of
              hundreds of other cryptocurrencies, collectively referred to as
              altcoins. Bitcoin is commonly abbreviated as "BTC."
            </p>
          </div>
          <div className="card-content">
            <h2 className="heading">Who is the founder?</h2>
            <p>
      ...
      {value === 1 ? (
        <>
          <div className="card-content">
            <h2 className="heading">What is Lorem Lipsum?</h2>
            <p>
